    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
          <div className="bg-[#ad343e] rounded-full p-6 mb-8 cursor-pointer hover:bg-[#9f0d08] transition-colors">
          ...
          <div className="flex gap-4">
            <Button className="bg-[#ad343e] hover:bg-[#9f0d08] text-white px-8 py-3 rounded-full">Partners</Button>
            <Button
              variant="outline"
      ...
      <section className="py-16 bg-[#f9f9f7]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-serif text-[#2c2f24] text-center mb-12">Browse Our Products</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-serif text-[#2c2f24] mb-6">We provide well known products.</h2>
              ...
              <div className="bg-[#ad343e] p-6 rounded-lg text-white">
      ...
      <section className="py-16 bg-[#f9f9f7]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-serif text-[#2c2f24] mb-12">Our brands</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-serif text-[#2c2f24] mb-12">Our Partners</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
