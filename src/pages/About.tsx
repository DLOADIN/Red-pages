      ...
      <section className="py-28 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-paragraph max-w-2xl mx-auto">Watch our journey from vision to reality</p>
          </div>
                      ...
                      <div className="relative aspect-[4/3] bg-gray-100 group">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                          <div className="bg-white/15 backdrop-blur-lg rounded-xl p-5 border border-white/25 shadow-lg">
                            ...
                            <h3 className="text-white font-bold text-xl mb-2">Our Story - Part {index + 1}</h3>
                            <p className="text-white/90 text-base">Watch our journey from vision to reality</p>
                          </div>
                        </div>
              ...
              {videos.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentVideoIndex ? "bg-white scale-125 shadow-lg" : "bg-white/50 hover:bg-white/75"
                  }`}
          ...
          {videoErrors.size > 0 && (
            <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <p className="text-yellow-700 text-sm mt-1">
                {videoErrors.size} of {videos.length} videos failed to load. Check the browser console for detailed
                error messages.
              </p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-paragraph">
                  We deliver diverse, high-quality food products through reliable networks, empowering businesses and
                  creating sustainable value across continents.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-paragraph">
                  To be a trusted global bridge in food distribution, connecting producers to Africa and Europe with
                  quality products that nourish communities and grow economies.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-paragraph">
                  To be a leading global food distribution company, bridging continents and cultures by providing
                  quality, diverse, and affordable food products that nourish communities and create shared prosperity.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="/rico website/pexels-pixabay-248412.jpg"
              alt="Featured Product"
              className="w-full max-w-lg h-[600px] rounded-2xl"
            />
          </div>
        </div>
      </section>
